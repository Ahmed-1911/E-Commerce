...
import 'package:yalla_sale/splash_screen.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void sure() async {
    ...
    print(
        _sharedPreferences.getString('pass') + '*******from sure************');
                ...
                Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        width: 180,
                        child: Text("اولاد الحج معروف للحديد والاسمنت", textAlign: TextAlign.center,
                          style:  TextStyle(
